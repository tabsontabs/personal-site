...
testJJ.fullAPI = '1e13836776bb968ad3492df125b59cbd'
testJJ.halfAPI = '1e13836776bb968a'
testJJ.timestamp = Math.round((new Date()).getTime() / 1000);
testJJ.securityHash = MD5(`${testJJ.timestamp}` + `${testJJ.fullAPI}`)

console.log(testJJ.securityHash);
console.log(`${testJJ.timestamp}` + `${testJJ.fullAPI}`);
